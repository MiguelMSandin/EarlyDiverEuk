...
This script will allow us to launch all **final BAMM analyses** with the launcher script [5.1_BAMM_launcher.sh](https://github.com/MiguelMSandin/EukEcoEvo/tree/main/scripts/8_diversificationBAMM/5.1_BAMM_launcher.sh), as done with the script [2_BAMMestimateBestShifts.sh](https://github.com/MiguelMSandin/EukEcoEvo/tree/main/scripts/8_diversificationBAMM/2_BAMMestimateBestShifts.sh).  
