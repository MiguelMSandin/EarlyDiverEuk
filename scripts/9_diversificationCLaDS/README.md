...
As for the script [6_BAMMextractRTT.sh] from the BAMM analyses(https://github.com/MiguelMSandin/EukEcoEvo/tree/main/scripts/8_diversificationBAMM/6_BAMMextractRTT.sh), this step is purposely convoluted to allow modifying headings according to different cluster needs and to ease the relaunch of possible failures.  
